 ...
 */
@Entity
@Table(name = "bill_detail", catalog = "vipmobileshopapi", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "BillDetail.findByIdSelectColor", query = "SELECT b FROM BillDetail b WHERE b.idSelectColor = :idSelectColor")})
public class BillDetail implements Serializable {
    ...
    @Column(name = "id_select_color")
    private Integer idSelectColor;
    ...
    public Integer getIdSelectColor() {
        return idSelectColor;
    }

    public void setIdSelectColor(Integer idSelectColor) {
